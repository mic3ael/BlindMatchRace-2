...
public class AdminActivity extends FragmentActivity implements LocationListener, OnClickListener {
	...
	/**
	 * This function is sound function
	 * when new buoy add this function return sound "new buoy was created"
	 */
	public void active(){
		tts = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
			...
			public void onInit(int arg0) {
				if(arg0 == TextToSpeech.SUCCESS) 
				{
					...
					tts.speak("new buoy was created",TextToSpeech.QUEUE_FLUSH,null);
				}
			}
		});
	}
